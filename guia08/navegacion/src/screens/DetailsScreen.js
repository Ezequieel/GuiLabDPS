...
{ id: '1', name: 'Proyecto 1', manager: 'Juan Pérez', contact:
'juan@example.com', socialMedia: ['facebook', 'x'] },
{ id: '2', name: 'Proyecto 2', manager: 'María González', contact:
'maria@example.com', socialMedia: ['instagram', 'linkedin'] },
{ id: '3', name: 'Proyecto 3', manager: 'Carlos Martínez', contact:
'carlos@example.com', socialMedia: ['x', 'linkedin'] },
...
<Image key={index} source={getSocialMediaIcon(social)}
...
switch (social) {
case 'facebook':
return require('../../assets/facebook (2).png');
case 'x':
return require('../../assets/x.png');
case 'instagram':
return require('../../assets/instagram (2).png');
case 'linkedin':
